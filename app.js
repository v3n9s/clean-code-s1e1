...
var taskInput=document.querySelector('#new-task-name');//Add a new task.
var addButton=document.querySelector('#add-new-task');//first button
...
var createNewTaskElement=function(taskString){
    ...
    //label
    var taskName=document.createElement("p");//label
    //input (text)
    ...
    editButton.className="task__action";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".task__action");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector(".task__action");
